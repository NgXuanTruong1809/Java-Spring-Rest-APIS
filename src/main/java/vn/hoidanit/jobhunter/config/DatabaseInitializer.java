...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (countPermissions == 0) {
            ...
            arr.add(new Permission("Fetch a company", "/api/v1/companies/{id}", "GET", "COMPANIES"));
            arr.add(new Permission("Fetch all companies", "/api/v1/companies", "GET", "COMPANIES"));
            ...
            arr.add(new Permission("Fetch a job", "/api/v1/jobs/{id}", "GET", "JOBS"));
            arr.add(new Permission("Fetch all jobs", "/api/v1/jobs", "GET", "JOBS"));

            arr.add(new Permission("Create a permission", "/api/v1/permissions", "POST", "PERMISSIONS"));
            arr.add(new Permission("Update a permission", "/api/v1/permissions", "PUT", "PERMISSIONS"));
            arr.add(new Permission("Delete a permission", "/api/v1/permissions/{id}", "DELETE", "PERMISSIONS"));
            arr.add(new Permission("Fetch a permission", "/api/v1/permissions/{id}", "GET", "PERMISSIONS"));
            ...
            arr.add(new Permission("Fetch a resume", "/api/v1/resumes/{id}", "GET", "RESUMES"));
            arr.add(new Permission("Fetch all resumes", "/api/v1/resumes", "GET", "RESUMES"));

            arr.add(new Permission("Create a role", "/api/v1/roles", "POST", "ROLES"));
            arr.add(new Permission("Update a role", "/api/v1/roles", "PUT", "ROLES"));
            arr.add(new Permission("Delete a role", "/api/v1/roles/{id}", "DELETE", "ROLES"));
            arr.add(new Permission("Fetch a role", "/api/v1/roles/{id}", "GET", "ROLES"));
            arr.add(new Permission("Fetch all roles", "/api/v1/roles", "GET", "ROLES"));

            arr.add(new Permission("Create a user", "/api/v1/users", "POST", "USERS"));
            arr.add(new Permission("Update a user", "/api/v1/users", "PUT", "USERS"));
            arr.add(new Permission("Delete a user", "/api/v1/users/{id}", "DELETE", "USERS"));
            arr.add(new Permission("Fetch a user", "/api/v1/users/{id}", "GET", "USERS"));
            arr.add(new Permission("Fetch all users", "/api/v1/users", "GET", "USERS"));
            ...
            arr.add(new Permission("Fetch a subscriber", "/api/v1/subscribers/{id}", "GET", "SUBSCRIBERS"));
            arr.add(new Permission("Fetch all subscribers", "/api/v1/subscribers", "GET", "SUBSCRIBERS"));
